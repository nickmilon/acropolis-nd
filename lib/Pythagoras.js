 ...
 * @exports { ngrams, isNumber, isObject, isString, isDate, isInRange, inRangeOrDefault, intOrDefault, percent, fileName, 
 ...
 * @return {boolean} true if string false otherwise
 */
export const isDate = (value) => (typeof value.getMonth === 'function');
