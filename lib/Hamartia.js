...
/**
 * @private this class is for use in this library only do not subclass it use @see ErrAcropolis instead
...
class ErrAcropolisND extends ErrAcropolis {
  ...
  static errorDict() {
    return {
      1001: 'EnumBits: flags must be < 53',
      1002: 'EnumBits: flags must be < 31 if allow allow52bits option is false',
