...
/**
   *
   * @param {obj || array of strings} flagsObjOrArray
   * if array a dictionary object will be auto constructed using powers of 2 with the given index within the array
   * i,e. const userFlags = new EnumBits(Object.freeze({ producer: 2, topArtist: 4, suggested: 8, verifiedArtist: 16})
   * or ['producer', 'verified']
   * can check both for a value or an array of values
   * @todo check if we reached Number.MAX_SAFE_INTEGER on constructor (currently 52 bits)
   */
